...
Read `HARNESS_GUIDE.md` when setting up, maintaining, or explaining the harness structure. For normal task execution, treat `docs/index.md` as the entry point.
