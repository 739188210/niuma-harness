...
- **Project users:** keep project-specific durable facts in source-backed scopes in `docs/project-context.md`; refresh only task-relevant facts against current workspace evidence; keep task-local plans, evidence, status, and handoff records in the workspace-level `agent-work/` directory.
