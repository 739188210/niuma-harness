...
3. Read only the task-relevant parts of `{{HARNESS_DIR}}/docs/project-context.md`, current README files, and verified runbooks to find stable facts and current operating guidance that may apply. When bootstrap, context staleness, or durable-fact maintenance is needed, also read `{{HARNESS_DIR}}/docs/process/bootstrap.md`.
