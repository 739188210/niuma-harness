...
5. Apply only the relevant triage conditions for bootstrap, Policy, module routing, ADRs, experience, or task-local recovery material. Do not enumerate decision, experience, or task-work directories speculatively; read a record only when the request, current workspace evidence, or an explicit reference establishes that it may apply.
